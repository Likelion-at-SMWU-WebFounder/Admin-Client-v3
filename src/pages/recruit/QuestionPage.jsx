      ...
      <L.Layout>
        ...
        <L.Container>
          ...
          <>
            ...
            <S.QuestionContainer>
              {questions[0]?.length > 0 && (
                <QuestionsList questions={questions[0]} onDelete={onDelete} />
              )}
          ...
          <>
            ...
            <S.QuestionContainer>
              {questions[1]?.length > 0 && (
                <QuestionsList questions={questions[1]} onDelete={onDelete} />
              )}
              <S.QuestionInputContainer>
                <S.QuestionInput
                  type="text"
          ...
          <>
            ...
            <S.QuestionContainer>
              {questions[2]?.length > 0 && (
                <QuestionsList questions={questions[2]} onDelete={onDelete} />
              )}
              <S.QuestionInputContainer>
                <S.QuestionInput
                  type="text"
          ...
          <>
            ...
            <S.QuestionContainer>
              {questions[3]?.length > 0 && (
                <QuestionsList questions={questions[3]} onDelete={onDelete} />
              )}
              <S.QuestionInputContainer>
                <S.QuestionInput
                  type="text"
